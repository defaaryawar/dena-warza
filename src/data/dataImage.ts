...
export const memories: Memory[] = [
    {
        id: '1',
        title: 'Pantai Date',
        description: 'Momen sunset paling epic bareng pasangan - dimana ombak jadi saksi cinta, pasir jadi teman cerita, dan senja menciptakan kenangan tak terlupakan! Pantai cantik, chemistry makin kece 💕🌅',
        date: '2024-11-09',
        media: [
            {
                type: 'photo',
    ...
    },
    {
        id: '2',
        title: 'First Date',
        description: 'Momen pertama kali ngedate - vibes nyaris sempurna! Deg-degan, senyum-senyum kayak di FTV, moment yang bakal selalu diinget 💖✨ Mall jadi saksi bisu chemistry kita yang lagi ngebloom! 😍🔥',
        date: '2024-09-08',
        media: [
            {
                type: 'photo',
    ...
    {
        id: '3',
        title: 'Mini Market Date',
        description: 'Gila seru! Kencan paling random tapi berkesan - hunting snack bareng, candaan di antara rak-rak mini market, moment yang bikin hubungan makin solid! 😂❤️🛒',
        date: '2024-09-16',
        media: [
            {
                type: 'photo',
    ...
    {
        id: '4',
        title: 'Pecel Lele Date',
        description: '🐟 Pecel Lele date berdua, seru banget! Makan makanan Indonesia banget ini mah, uyy~ 🤤💕 | Nikmatnya kebersamaan sama orang spesial 🥰',
        date: '2024-09-16',
        media: [
            {
                type: 'photo',
    ...
    },
    {
        id: '5',
        title: 'Mall Date',
        description: 'ini pas kita lagi gabut aja ke mall bu bos minta kesana hehehe... ❤️',
        date: '2025-01-05',
        media: [
            {
                type: 'photo',
            ...
            // {
            //     type: 'video',
            //     url: '/videos/ngedate/mall-date.mp4',
            //     thumbnail: '/images/ngedate/mall-date-thumb.webp'
            // },
            // {
            //     type: 'video',
            //     url: '/videos/ngedate/mall-date2.mp4',
    ...
    },
    {
        id: '6',
        title: 'Photo Both',
        description: '📸 Photo Both bareng orang terbaik, itu emang sebegitu menyenangkannya ya~ 💖 | Moment yang bikin senyum terus 🥰',
        date: '2024-12-08',
        media: [
            {
                type: 'photo',
    ...
    },
    {
        id: '7',
        title: 'Cafe Date',
        description: 'Ngopi bareng sambil ngobrol sampe lupa waktu... ☕❤️',
        date: '2024-10-25',
        media: [
            {
                type: 'photo',
    ...
    },
    {
        id: '8',
        title: 'Ragunan Date',
        description: 'Lihat satwa di ragunan bareng favorite people, walaupun ngambek terus 😭🥺',
        date: '2024-10-27',
        media: [
            {
                type: 'photo',
    ...
    },
    {
        id: '9',
        title: 'Bioskop Date',
        description: 'Mau nonton lembayung ni ceritanya si bu bos penakut bangett wkwkkwkw..',
        date: '2024-09-19',
        media: [
            {
                type: 'photo',
    ...
    {
        id: '10',
        title: 'Kopi Nako Date',
        description: '☕ Ngopi santai di Nako, ceritanya si bu bos lagi butuh suasana baru~ 🌿✨',
        date: '2024-10-05',
        media: [
            {
                type: 'photo',
    ...
    {
        id: '11',
        title: 'Kopi Kembali ke Alam Date',
        description: '☕🌿 Momen spesial menikmati kopi di tengah alam, berbagi keheningan dan kedekatan. Secangkir kopi, pemandangan hijau, dan kebersamaan yang menenangkan 💖',
        date: '2024-10-19',
        media: [
            {
                type: 'photo',
    ...
    },
    {
        id: '12',
        title: 'Wisudaan',
        description: '🎓✨ Momen kelulusan penuh kebanggaan dan kebahagiaan! Wisuda bareng, saling mendukung dan mengukir kenangan manis di hari spesial ini 💖',
        date: '2024-11-14',
        media: [
            {
                type: 'photo',
    ...
    {
        id: '13',
        title: 'Roti Buaya Date',
        description: '🥖❤️ Bu bos lagi pengen roti buaya di Blok M, turutin ajadah dari pada manyun 😍🔥',
        date: '2025-01-05',
        media: [
            {
                type: 'photo',
    ...
    {
        id: '14',
        title: 'Jalan2 Date sambil Nyemil',
        description: 'Jalan-jalan sore sama ibu negara, suka, seneng, bahagia, karena bareng wanita terbaik 🔥💖',
        date: '2025-01-31',
        media: [
            {
                type: 'photo',
